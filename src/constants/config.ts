export const CONFIG = {
  ...
  language: 'Phonemic Wordle for Australian English (HCE system)', // This changes the display name for your language
  ...
  //
  googleAnalytics: 'G-BX6GLBPWV5', // You can use this if you use Google Analytics
